      ...
      setMessages([
        {
          data: {
            ...
            content:
              ...
              "\n" +
              "    进行语言处理：识别、翻译、转换、分析、生成等。\n" +
              "    回答问题：根据输入的问题，提供相关的答案和解决方案。\n" +
              "    辅助写作：提供语法纠错、词汇替换、写作建议等帮助。\n" +
              "    自动化客服：可以代替一部分客服工作，进行问题解答和信息查询等功能。\n" +
              "    数据分析：对大量数据进行分析，提供数据挖掘、关联性分析、聚类分析、预测分析等。\n" +
              "    智能推荐：根据用户的历史数据和需求，提供个性化的推荐和建议。\n" +
              "    其他辅助功能：如情感分析、智能助手等。",
          },
