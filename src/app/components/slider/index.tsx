...
export default function Slider(props: { isMobile?: boolean, closeSlider?: () => void }) {
    ...
    return (
        <div className={`${styles.slider} ${props.isMobile ? styles.mobile : undefined}`}>
            <div
                style={{
                    position: "absolute",
                    right: -10,
